...
class VideoStreamWidget(object):
    ...
    def show_frame(self):
        ...
        if np.all(ids !=None):
            ...
            if (posicion_1.size==0 or posicion_4.size==0 or ubicacion.shape[0]==0)==True:
                cv.putText(procesamiento_l, "PERDIDA DE MARCADOR LLANTAS", (0,450), font, 1, (0,0,0),1,cv.LINE_AA)
            else:
                ## elemetos para graficar el marcador en el plano d ela imagen 
                punto_0=datos_esquinas[posicion_1[0][0]].reshape(4,2)
                punto_0[0][1]=punto_0[0][1]
                ...
                for i in range(0,ubicacion.shape[0]):
                    ...
                    print(err_x_linea2,err_y_linea1,err_y_linea1,err_y_linea2)
                    if (err_x_linea1>0 and err_y_linea1>0 and err_x_linea2>0 and err_y_linea2>0):
                        ...
                        cv.putText(procesamiento_l, "FUERA DEL AREA", (0,350), font, 1, (0,0,0),1,cv.LINE_AA)       
        else:
